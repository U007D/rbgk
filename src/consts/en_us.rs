...
pub const MSG_ERR_NO_ROLLS: &str = "No rolls have occurred";
...
pub const MSG_ERR_INVALID_GAME: &str = "Too many roll values provided--invalid game";
pub const MSG_ERR_INTERNAL_ROLL_NONE: &str = "Internal error: Roll was unexpectedly `None`";
